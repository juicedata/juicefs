...
- Before starting work on a feature or bug fix, please search GitHub or reach out to us via GitHub, Discord etc. The purpose of this step is make sure no one else is already working on it and we'll ask you to open a GitHub issue if necessary.
