...
generated by scripts/gen-fixtures.py -- the manifest footer plus protobuf wire
...
here comes from the upstream v11 sources pinned by scripts/gen-protos.sh, and all
...
Usage: python scripts/dump_fixture.py <dataset-dir> <output-json>
"""
...
# scripts/gen-protos.sh (authoritative for what the Go resolver decodes).
