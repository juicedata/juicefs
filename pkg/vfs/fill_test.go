...
func TestFill(t *testing.T) {
	...
	// normal cases
	v.cache(meta.Background(), WarmupCache, []string{"/test/file", "/test", "/sym", "/"}, 2, nil, nil)
	...
	// bad cases
	v.cache(meta.Background(), WarmupCache, []string{"/test/file", "/sym2", "/sym3", "/.stats", "/not_exists"}, 2, nil, nil)
}
