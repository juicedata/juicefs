...
func init() {
	...
	httpClient = &http.Client{
		Transport: newHTTPTransportGeneration(httpTransport, parseHTTPConnMaxAge()),
		Timeout:   time.Hour,
	}
}
...
// GetHttpTransport returns the shared base transport for integrations that require *http.Transport.
