...
func newWasabi(endpoint, accessKey, secretKey, token, storageClass string) (ObjectStorage, error) {
	...
	return &wasabi{s3client{bucket, storageClass, s3.New(ses), ses}}, nil
}
