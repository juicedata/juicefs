...
func (c *ceph) Create(ctx context.Context) error {
...
func (c *ceph) Get(ctx context.Context, key string, off, limit int64, getters ...AttrGetter) (io.ReadCloser, error) {
...
func (c *ceph) Put(ctx context.Context, key string, in io.Reader, getters ...AttrGetter) error {
...
func (c *ceph) Delete(ctx context.Context, key string, getters ...AttrGetter) error {
...
func (c *ceph) Head(ctx context.Context, key string) (Object, error) {
	var o *obj
	err := c.do(func(ctx *rados.IOContext) error {
...
func (c *ceph) ListAll(ctx context.Context, prefix, marker string, followLink bool) (<-chan Object, error) {
	ctx, err := c.newContext()
	if err != nil {
		return nil, err
	}
