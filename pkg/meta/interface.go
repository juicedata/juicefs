...
type Meta interface {
	...
	Remove(ctx Context, parent Ino, name string, skipTrash bool, count *uint64) syscall.Errno
	RemoveEx(ctx Context, parent Ino, name string, skipTrash bool, numThreads int, count *uint64) syscall.Errno
