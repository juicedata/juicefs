...
func (m *kvMeta) doSyncDirStat(ctx Context, ino Ino) (length, space, inodes uint64, err error) {
...
func (m *kvMeta) doGetDirStat(ctx Context, ino Ino) (length, space, inodes uint64, err error) {
