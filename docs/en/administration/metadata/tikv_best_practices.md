...
:::tip
This command also removes leaked objects and pending-deletion objects generated by JuiceFS. Refer to [Status Check and Maintenance](../status_check_and_maintenance.md#gc) to determine whether you should use it.
:::
