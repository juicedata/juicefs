...
1. Prepare a YAML file
   ...
   - name: juicefs-sc
     ...
     backend:
       ...
       bucket: "<bucket>"
       # If you're using Azure blob , please config its connection string, core.chinacloudapi.cn stands for Azure China 
       envs: "{\"AZURE_STORAGE_CONNECTION_STRING\": \"DefaultEndpointsProtocol=https;AccountName=xxx;AccountKey=xxx;EndpointSuffix=core.chinacloudapi.cn\"}"
     mountPod:
       resources:
         limits:
           cpu: "<cpu-limit>"
