...
## Use a more fully functional Gateway
If you need to use some advanced functions of Gateway, you can pull [the gateway branch of the repository](https://github.com/juicedata/minio/tree/gateway) and compile it yourself. This is a fork base on  [minio RELEASE.2022-03-05T06-32-39Z version](https://github.com/minio/minio/tree/RELEASE.2022-03-05T06-32-39Z). We implemented the feature of juicefs as one of its gateway implementations. This version supports using juicefs as the backend while using the full functionality native to minio gateway, such as [multi-user management]( https://docs.min.io/docs/minio-multi-user-quickstart-guide.html ).
