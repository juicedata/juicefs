...
|`--fast-statfs` <VersionAdd>1.3</VersionAdd>|performance is improved by using local caching to reduce metadata access, but accuracy may decrease (default: false)|
