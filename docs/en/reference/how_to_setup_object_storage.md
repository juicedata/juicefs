...
In addition to the public Endpoint, some object storage services also provide internal Endpoint for inter-service communication between their own platforms, meeting the conditions of the cloud server using internal Endpoint access to object storage is not only lower latency, and the traffic generated by internal communication is free.
