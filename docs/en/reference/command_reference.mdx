...
|`--storage-class=value` <VersionAdd>1.1</VersionAdd>|Storage class for the given tier (for example, `STANDARD_IA`, `INTELLIGENT_TIERING`, and `GLACIER_IR`). Used together with `--tier`.|
