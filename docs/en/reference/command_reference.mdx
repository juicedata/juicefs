...
|`--disable-transparent-hugepage` <VersionAdd>1.3</VersionAdd> |Disable the kernel’s Transparent Huge Pages. In situations like memory pressure, keeping THP enabled may cause processes to hang. (default: false)|
