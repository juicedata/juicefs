...
| 客户端             | FUSE + S3 直接读取          | POSIX（FUSE）、Java SDK、Python SDK、S3 网关        | POSIX（FUSE）、Java SDK、Python SDK、S3 网关 |
| 多云镜像（Mirror） | 不支持                      | 不支持                                              | ✓ 支持                                       |
| 跨云复制           | 不支持                      | 不支持                                              | ✓ 支持                                       |
| 跨区域复制         | ✓ 由 S3 本身支持            | 不支持                                              | ✓ 支持                                       |
