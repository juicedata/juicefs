...
|`--enable-cap` <VersionAdd>1.3</VersionAdd>|启用security.capability扩展属性 (xattr) ，默认为 false。|
|`--enable-selinux` <VersionAdd>1.3</VersionAdd>|启用security.selinux扩展属性 (xattr) ，默认为 false。|
