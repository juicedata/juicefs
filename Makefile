...
test:
	go test -v -cover ./pkg/... ./cmd/...  -coverprofile=cov1.out -race -covermode=atomic
	sudo `which go` test ./integration/... -cover -coverprofile=cov2.out -coverpkg=./pkg/...,./cmd/... -race -covermode=atomic