...
8. **数据安全**：支持传输中加密（encryption in transit）以及静态加密（encryption at rest），[查看详情](docs/zh_cn/secuirty/encrypt.md)；
...
请参照 [快速上手指南](docs/zh_cn/getting-started/_quick_start_guide.md) 立即开始使用 JuiceFS！
