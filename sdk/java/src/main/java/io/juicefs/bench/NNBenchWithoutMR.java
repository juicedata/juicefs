...
public class NNBenchWithoutMR {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if ("createWrite".equals(operation)) {
    ...
    } else if ("openRead".equals(operation)) {
      exceptions = openRead();
    ...
    if ("createWrite".equals(operation)) {
      System.out.println("The " + operation + " TPS " + ((int) ((double) numFiles / (endTime.getTime() - execTime.getTime()) * 1000 * 2)));
    } else {
